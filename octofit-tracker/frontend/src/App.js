    ...
    <Router>
      <nav className="navbar navbar-expand-lg octofit-navbar mb-4">
        <div className="container-fluid">
          <Link className="navbar-brand d-flex align-items-center octofit-fun-font" to="/">
      ...
      <div className="container">
        <Routes>
          ...
          <Route path="/" element={<h1 className="display-4 text-center octofit-fun-font">Welcome to OctoFit Tracker</h1>} />
        </Routes>
      </div>
    </Router>
  );
